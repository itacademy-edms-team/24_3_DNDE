...
// Type: SeedWorks.IIntegrationEvent
...
/// <summary>Интерйес интеграционного события.</summary>
public interface IIntegrationEvent
{
    /// <summary>Идентификатор интеграционного события.</summary>
    Guid Id { get; }

    /// <summary>Дата и время интеграционного события.</summary>
