...
namespace FinanceTrack.Finance.FunctionalTests.ApiEndpoints;
    ...
    : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    public async Task ReturnsTwoContributors()
    {
        ...
        result.Contributors.ShouldContain(contributor =>
            contributor.Name == SeedData.Contributor1.Name
        );
        result.Contributors.ShouldContain(contributor =>
            contributor.Name == SeedData.Contributor2.Name
        );
    }
}
