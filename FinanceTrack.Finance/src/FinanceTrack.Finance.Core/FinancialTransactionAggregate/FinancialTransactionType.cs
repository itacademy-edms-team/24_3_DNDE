...
public class FinancialTransactionType : SmartEnum<FinancialTransactionType>
{
    ...
    public static readonly FinancialTransactionType TransferIn = new(nameof(TransferIn), 3);
    public static readonly FinancialTransactionType TransferOut = new(nameof(TransferOut), 4);
