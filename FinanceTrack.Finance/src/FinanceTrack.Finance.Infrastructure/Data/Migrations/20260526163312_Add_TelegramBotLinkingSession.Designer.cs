...
namespace FinanceTrack.Finance.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260526163312_Add_TelegramBotLinkingSession")]
    partial class Add_TelegramBotLinkingSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceTrack.Finance.Core.RecurringTransactionAggregate.RecurringTransaction", b =>
                {
                    ...
                    b.Property<DateOnly?>("LastEmailReminderDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("FinanceTrack.Finance.Core.TelegramBotLinkingSessionAggregate.TelegramBotLinkingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TelegramBotLinkingSessions");
                });

            modelBuilder.Entity("FinanceTrack.Finance.Core.UserAggregate.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinanceTrack.Finance.Core.WalletInsightAggregate.WalletInsight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AnomaliesText")
                        .HasColumnType("text");

                    b.Property<string>("ExpenseStructureText")
                        .HasColumnType("text");

                    b.Property<DateTime>("GeneratedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateOnly>("InsightMonth")
                        .HasColumnType("date");

                    b.Property<string>("RecommendationsText")
                        .HasColumnType("text");

                    b.Property<string>("TrendsText")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("WalletId", "UserId", "InsightMonth")
                        .IsUnique();

                    b.ToTable("WalletInsights");
                });
