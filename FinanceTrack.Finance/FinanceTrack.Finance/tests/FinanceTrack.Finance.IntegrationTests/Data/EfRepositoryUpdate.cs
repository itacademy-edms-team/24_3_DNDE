...
public class EfRepositoryUpdate : BaseEfRepoTestFixture
{
    ...
    public async Task UpdatesItemAfterAddingIt()
    {
        ...
        var newContributor = (await repository.ListAsync()).FirstOrDefault(Contributor =>
            Contributor.Name == initialName
        );
        ...
        var updatedItem = (await repository.ListAsync()).FirstOrDefault(Contributor =>
