...
namespace FinanceTrack.Finance.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251203094410_UpdateTransaction_AddNameField")]
    partial class UpdateTransaction_AddNameField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceTrack.Finance.Core.TransactionAggregate.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinanceTrack.Finance.Core.TransactionAggregate.Transaction", b =>
                {
                    b.HasOne("FinanceTrack.Finance.Core.TransactionAggregate.Transaction", "IncomeTransaction")
                        .WithMany()
