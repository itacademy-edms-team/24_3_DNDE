...
2. Run command
```bash
docker compose --env-file .env.development run --rm keycloak export --dir=/temp/exports
```
...
2. Run command
```bash
docker compose --env-file .env.development run --rm keycloak import --dir=/temp/exports
```
