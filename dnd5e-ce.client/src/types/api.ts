...
 export type LoginData = {   email: string;   password: string; };  export interface IRegisterFormData {   username: string;   email: string;   password: string;   passwordConfirm: string; }  export interface ILoginFormData {   email: string;   password: string; }  export interface AuthResponse {   success: boolean;   errors: string[]; }  export interface Sheet1Dto
{
  //header fields
  name: string;
  class: string;
